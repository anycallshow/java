...
public class MemberService {
	...
	public MemberService() { // 기본 생성자 
		...
		memberArr[0] = new Member("user01", "pass01", "유저일", 25, "서울");
		memberArr[1] = new Member("user02", "pass02", "예수", 00, "인천");
		memberArr[2] = new Member("user03", "pass03", "염라대왕", 999, "충북");
	}
	...
	public String signUp() {
		...
		System.out.print("현재 회원 수 : " + index + "명");
	...
	public void searchRegion() {
		...
		for (int i = 0; i < memberArr.length; i++) {
			...
			//    입력 받은 지역(inputRegion)과 같은 경우(.equals()), 회원의 아이디, 이름을 출력
