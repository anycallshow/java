...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		// 2-3. 배열 요소 값 대입
		// arr은 int[] 참조형 변수 이지만
		// arr[0] int 자료형 변수이기 때문에 정수 값을 대입 할 수 있다.
	...
	public void ex7() {
		...
		// 신호를 나타내기 위한 변수
		// flag == false : 일치하는 값이 존재하지 앟음
		// falg == true : 일치하는 값이 존재
	...
	public void ex9() {
		...
		char ch = sc.nextLine().charAt(0); // 띄어쓰기 포함 <-> next() 띄어쓰기 불포함
