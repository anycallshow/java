...
public class PolyService {
	...
	public void ex1() {
		...
		car2.setFuel("전기");
		car2.setWheel(4);
		// car2.setBatteryCapacity(10000000); // 오류 발생 
		...
		// 다형성 (업캐스팅) : 부모 타입 참조변수 arr[i]로 자식 객체 참조할 수 있다.
	...
	public void ex2() {
		...
		for (int i = 0; i < arr.length; i++) {
			...
			if(arr[i] instanceof Tesla) {
				...
				System.out.println("Spakr 객체 입니다.");
	...
	public void printCar(Car temp) {
		...
		// 매소드 내부 변수 + 매개변수 == 지역 변수(Local Variable)
	...
	// 전달 받은 매개변수에 따라 Car 또는 자식 객체를 생성하고
	// 생성된 객체의 주소를 반환
