...
public class SetService {
	...
	public void ex1() {
		...
		while(it.hasNext()) { // 하나씩 꺼냈을 때 다음 값이 없는 경우(false) == 끝
			// -> 다음 값이 있으면(true) 반복해야 한다!
	...
	public void ex2() {
		...
		// mem1과 mem2가 같은지 비교
		System.out.println(mem1 == mem2); // 주소값 비교
		...
		// == equals() 메소드 오버라이딩 (Member 클래스)
		
		System.out.println("-------------------------------------");
		System.out.println( mem1.equals(mem2)); // mem1, mem2의 필드는 같은가? true
		System.out.println( mem1.equals(mem3)); // mem1, mem3의 필드는 같은가? false
...
//		Set<Integer> lotto = new LinkedHashSet<Integer>();
	...
	public void ex4() {
		...
		System.out.println( num1 + num2 ); // 101.23456 출력
