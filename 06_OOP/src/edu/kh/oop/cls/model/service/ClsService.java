...
//import edu.kh.oop.cls.model.vo.TsetVo;
// The import edu.kh.oop.cls.model.vo.TsetVo cannot be resolved
...
//		System.out.println(v4);
	...
	public void ex2() {
		...
		System.out.println("std2 : " + std2.schoolName);
		...
		System.out.println("Studen.schoolName : " + Student.schoolName);
	...
	public void ex3() {
		...
		Student s1 = new Student();
						...
						// 2) Student() Student객체가 생성된 후 기본생성자에 작성된 코드를 수행하라
	...
	public void ex4() { // 매개변수 생성자 예제
		...
		User u4 = new User("user04", "pass04", "안기모", 28, '남'); // 매개변수 5개 생성자
		User u5 = new User("user05", "pass04", "칼이나", 29, '여'); // 매개변수 5개 생성자
