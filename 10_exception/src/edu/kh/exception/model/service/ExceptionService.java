...
public class ExceptionService {
	...
	public void ex1() {
		...
		try {
			...
			System.out.println("inficity"); // 처리 코드
		}
	...
	public void ex3() {
		...
		try {
			...
			// * NullPointerException : 참조하지 않은 참조변수를 이용해서 코드를 수행할 때 발생
	...
	public void ex5() {
		...
		// 			-> 호출한 메소드에게 예외를 처리하라고 위임하는 행위 (책임전가)
	...
	public void methodD() {
		...
		// --> 예외처리 구문이 아니라 if문 같은 단순 코드로도 해결이 가능
